        ...
        <section className="mx-auto flex w-full flex-col items-center justify-center gap-10 lg:flex-row lg:items-start lg:gap-16">
          <div className="hidden md:flex w-full max-w-lg flex-col items-center justify-center rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_25px_60px_-30px_rgba(255,255,255,0.25)] backdrop-blur-sm">
            <div className="mb-8 flex flex-col items-center text-center gap-5">
              <div className="flex h-24 w-24 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/10" aria-label="Instagram Logo">
      ...
      <div className="w-full max-w-md flex flex-col items-center px-4 md:px-0">
        ...
        <div className='flex justify-center' aria-hidden="true">
         <svg aria-label="Instagram" color="white" fill="white" height="48" role="img" viewBox="0 0 24 24" width="48">
          ...
          <h1 className="text-center text-2xl font-semibold mt-2 mb-4">Log in to Instagram Lite</h1>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-linear-to-r from-blue-500 to-sky-500 hover:from-blue-400 hover:to-sky-400 disabled:from-blue-500/50 disabled:to-sky-500/50 disabled:cursor-not-allowed transition-colors text-white font-semibold rounded-2xl py-3 mt-4 text-sm"
              aria-busy={loading}
            >
          ...
          <a href="#" className="text-sm mt-6 hover:opacity-70 transition-opacity">
            Forgotten password?
          </a>
          <Link href="/signup" className="w-full border border-[#363636] rounded-lg py-2 mt-6 bg-linear-to-r from-blue-500 to-sky-500 hover:from-blue-400 text-sm font-semibold text-center transition-colors">
            Create new account
          </Link>
          </div>
        </div>
